...
function App() {
  ...
  const fetchItems = async () => {
    try {
      const res = await axios.get('https://testbackend-production-8352.up.railway.app/api/items');
      setItems(res.data);
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://testbackend-production-8352.up.railway.app/api/items', formData);
